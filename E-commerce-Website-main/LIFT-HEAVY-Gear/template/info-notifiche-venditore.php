<section>
    ...
    <?php if (isset($templateParams["prodotti_in_esaurimento"]) && count($templateParams["prodotti_in_esaurimento"]) > 0): ?>
        <?php foreach ($templateParams["prodotti_in_esaurimento"] as $prodotto): ?>
            <div class="notifica">
                ...
                <p>Peso: <?php echo $prodotto['peso']; ?>kg</p>
                <p>Lunghezza: <?php echo $prodotto['lunghezza']; ?>cm</p>
            </div>
        <?php endforeach; ?>
    <?php else: ?>
